  ...
  return (
    <div className="flex flex-col gap-12 max-w-4xl mx-auto py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-card border border-border p-8 rounded-3xl flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <div key={i} className="flex flex-col items-center justify-center gap-2 p-6 border-t-2 border-primary/30">

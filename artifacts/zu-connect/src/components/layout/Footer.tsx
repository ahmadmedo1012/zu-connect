      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col gap-4">
            <h3 className="font-bold text-xl text-white">ZU Connect</h3>
          ...
          <div className="flex flex-col gap-4">
            <h3 className="font-bold text-lg text-white">روابط سريعة</h3>
          ...
          <div className="flex flex-col gap-4">
            <h3 className="font-bold text-lg text-white">تواصل معنا</h3>

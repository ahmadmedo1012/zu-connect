...
export function Topbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border bg-black/90 backdrop-blur supports-[backdrop-filter]:bg-black/60">
        ...
        <div className="flex items-center gap-4">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-lg leading-tight text-white tracking-tight">ZU Connect</span>
